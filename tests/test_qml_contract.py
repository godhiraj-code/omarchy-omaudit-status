...
class QmlContractTests(unittest.TestCase):
    ...
    def test_panel_only_reads_the_shared_service_and_exposes_required_actions(self):
        ...
        self.assertIn('readonly property var hostBarConfig: bar ? bar.barConfig : null', self.panel)
        self.assertIn('onHostBarConfigChanged: Qt.callLater(root.configureService)', self.panel)
